...
REM Installa i backend video consigliati (solo VLC e PyQt su Windows)
...
REM Nota: pympv/libmpv e GStreamer non vengono configurati da questo setup su Windows.
REM       Se necessario, configura manualmente questi backend in un secondo momento.
